...
// import {logo} from "../data/data.json" (this was original)
// Correct way to import with default export (fixed from gpt)
import data from "../data/data.json";

// Accessing the logo property from the imported data
const { logo } = data;
